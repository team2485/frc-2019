...
public class Pipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double resizeImageWidth = 128.0;
		double resizeImageHeight = 96.0;
		int resizeImageInterpolation = Imgproc.INTER_CUBIC;
		resizeImage(resizeImageInput, resizeImageWidth, resizeImageHeight, resizeImageInterpolation, resizeImageOutput);

		// Step HSV_Threshold0:
		Mat hsvThresholdInput = resizeImageOutput;
		double[] hsvThresholdHue = {57.86693113967421, 123.50349865728005};
		double[] hsvThresholdSaturation = {0.0, 115.60606349598277};
		double[] hsvThresholdValue = {204.8964279519636, 255.0};
